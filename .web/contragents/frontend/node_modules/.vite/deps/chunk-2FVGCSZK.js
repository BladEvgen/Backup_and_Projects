...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React13.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React13.useEffect(() => {
  ...
  const updateRootElementName = React13.useCallback((instance) => {
...
var FormControlContext2 = React22.createContext(void 0);
if (true) {
...
var FormControl = React23.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime17.jsx)(FormControlContext2.Provider, {
    value: childContext,
...
function useFormControlContext() {
  return React24.useContext(FormControlContext2);
}
...
var Menu = React41.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuItemContextStabilizer(id) {
  const listContext = React45.useContext(ListContext);
  if (!listContext) {
...
var Modal = React48.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
var NumberInput = React50.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime27.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime27.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime27.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var PopperTooltip = React55.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React55.useState(resolveAnchorEl(anchorEl));
  React55.useEffect(() => {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime34.jsx)(React58.Fragment, {
...
var Select = React58.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime35.jsxs)(React58.Fragment, {
    children: [(0, import_jsx_runtime34.jsx)(Button3, _extends({}, buttonProps, {
...
var Slider = React60.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime36.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime36.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime37.jsxs)(React60.Fragment, {
...
var Snackbar = React62.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React64.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime40.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime39.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime39.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime39.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
var TablePaginationActions = React65.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React66.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime43.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime44.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime43.jsx)(Select3, _extends({}, selectProps, {
...
function useTabs(parameters) {
  ...
  const onSelected = React67.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React67.useRef(() => void 0);
  const getTabPanelId = React67.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React67.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React67.useCallback((lookupFunction) => {
...
function useTabsContext() {
  const context = React68.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const tabsContextValue = React69.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
...
var Tabs = React70.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React71.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React72.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React73.useCallback((tabValue) => {
    var _subitems$get;
    return (_subitems$get = subitems.get(tabValue)) == null ? void 0 : _subitems$get.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React73.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React73.useCallback((tabValue) => {
  ...
  const handleChange = React73.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React73.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React73.useCallback((item) => {
  ...
  const contextValue = React73.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React75.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var Tab = React77.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
var inputGlobalStyles = (0, import_jsx_runtime53.jsx)(GlobalStyles_default2, {
  styles: {
...
var InputBase = React80.forwardRef(function InputBase2(inProps, ref) {
  ...
  const {
    current: isControlled
  } = React80.useRef(value != null);
  const inputRef = React80.useRef();
  const handleInputRefWarning = React80.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React80.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  return (0, import_jsx_runtime54.jsxs)(React80.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2FVGCSZK.js.map
