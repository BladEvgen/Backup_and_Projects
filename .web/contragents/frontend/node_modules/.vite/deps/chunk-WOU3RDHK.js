...
var IconButton = React3.forwardRef(function IconButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsx)(IconButtonRoot, _extends({
    className: clsx_default(classes.root, className),
    centerRipple: true,
...
var Autocomplete = React7.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => (0, import_jsx_runtime8.jsx)(Chip_default, _extends({
  ...
  return (0, import_jsx_runtime9.jsxs)(React7.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)(AutocompleteRoot, _extends({
      ref,
      className: clsx_default(classes.root, className),
      ownerState
    }, getRootProps(other), {
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: (0, import_jsx_runtime9.jsxs)(AutocompleteEndAdornment, {
            ...
            ownerState,
            children: [hasClearIcon ? (0, import_jsx_runtime8.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? (0, import_jsx_runtime8.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? (0, import_jsx_runtime8.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: (0, import_jsx_runtime9.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime8.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
...
//# sourceMappingURL=chunk-WOU3RDHK.js.map
